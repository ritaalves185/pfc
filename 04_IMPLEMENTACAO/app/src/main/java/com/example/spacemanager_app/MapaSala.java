...
public class MapaSala extends AppCompatActivity implements View.OnClickListener{

    private ConstraintLayout constraintLayout;
    Button lugar1,lugar2,lugar3,lugar4,lugar5,lugar6,lugar7,lugar8,lugar9,lugar10,lugar11,lugar12;
    FirebaseDatabase firebaseDatabase;
    DatabaseReference ref, reservas;
    String sala = "1";
    ...
    private void reservas(String sala, int lugar) {
        reservas.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (daparareservar) {
                    reserva(lugar);
                    Intent intent_lugarobtido = new Intent(MapaSala.this, LugarObtido.class);
                    ...
                    intent_lugarobtido.putExtra("tipo", "mapa");
                    MapaSala.this.startActivity(intent_lugarobtido);
                } else {
                    Toast.makeText(getApplicationContext(), R.string.naofazerreserva, Toast.LENGTH_LONG).show();
                    Intent intent_lugarobtido = new Intent(MapaSala.this, Reserva.class);
                    MapaSala.this.startActivity(intent_lugarobtido);
                }
            }
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.BReservar:
                ...
                break;
            case R.id.BVoltar:
                Intent intent_voltar = new Intent(MapaSala.this, Reserva.class);
                MapaSala.this.startActivity(intent_voltar);
                break;
        }
    }
